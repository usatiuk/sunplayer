...
How should Sunroom reproducibly build the pinned libplacebo dependency on
...
* Sunroom and the installed Qt 6.11.1 package use the MSVC ABI.
...
Debug and Release libplacebo packages. Sunroom itself remained compiled with
...
Those packages do not enable a Vulkan renderer in Sunroom. The libplacebo port
