...
the real SDR and HDR render boundaries, nominal-100 and physical-HDR target-unit
normalization, HDR10+ OOTF selection on a selected non-Dolby representation for
SDR and known-luminance HDR, and remapping of the same paused dual-format frame
across SDR/HDR target classes.
