...
function(_sunplayer_find_ffmpeg_runtime
        output_variable
        library
        component)
...
function(sunplayer_configure_ffmpeg)
    add_library(sunplayer_ffmpeg INTERFACE)
    ...
    if (WIN32)
        ...
        target_include_directories(sunplayer_ffmpeg
                INTERFACE
                ${FFMPEG_INCLUDE_DIRS}
        )
        ...
        foreach (component IN ITEMS
            ...
            _sunplayer_find_ffmpeg_runtime(
                    release_runtime
                    "${${release_variable}}"
                    "${component}"
            )
        ...
        set(
                SUNPLAYER_FFMPEG_RUNTIME_TARGETS
                "${runtime_targets}"
                PARENT_SCOPE
        )
    elseif (APPLE)
        ...
        target_link_libraries(sunplayer_ffmpeg
                INTERFACE
                ${FFMPEG_LIBRARIES}
        )
        set(SUNPLAYER_FFMPEG_RUNTIME_TARGETS "" PARENT_SCOPE)
    elseif (CMAKE_SYSTEM_NAME STREQUAL "Linux")
        find_package(PkgConfig REQUIRED)
        pkg_check_modules(SUNPLAYER_FFMPEG REQUIRED
                IMPORTED_TARGET
                GLOBAL
                libavutil>=60
                libavutil<61
