...
class SubtitleSource final {
  ...
  private:
    ...
    std::shared_ptr<SubtitleStreamConfiguration const> m_configuration;
    std::shared_ptr<std::vector<SubtitleEvent>> m_events = std::make_shared<std::vector<SubtitleEvent>>();
