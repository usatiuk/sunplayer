...
public:
    ...
    virtual VideoTargetUpdate ensureTarget(
        const RenderedVideoSurfaceDescription &description) = 0;
    ...
    virtual VideoOperationResult beginProducerAccess(
        QRhiCommandBuffer &commandBuffer) = 0;
    virtual VideoOperationResult endProducerAccess(
        QRhiCommandBuffer &commandBuffer) = 0;
